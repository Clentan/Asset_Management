...
import UserManagement from "./pages/dashboard/users/users";
import InventoryMangement from "./pages/dashboard/inventory";
import AssetMovement from "./pages/dashboard/assetMovement/assetMovement";
  ...
  return (
    <Routes>
        ...
        <Route path="/dashboard/*" element={isAuthenticated ? <Dashboard /> : <Navigate to={"/signin"}/>}>
          ...
          <Route path="inventory-management" element={<InventoryMangement />}/>
          <Route path="asset-control" element={<AssetMovement />}/>
        </Route>
    </Routes>
  );
}
